...
import QuantityLimits from "./Allocation/QuantityLimits";
  ...
  return (
    <Routes>
      ...
      <Route element={<AdminLayout />}>
        ...
        <Route path="/CreateAllocation" element={<CreateAllocation />} />
        <Route path="/QuantityLimits" element={<QuantityLimits />} />
      </Route>
    </Routes>
  );
}
